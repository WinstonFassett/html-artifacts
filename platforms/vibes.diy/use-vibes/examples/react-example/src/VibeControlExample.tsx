    ...
    <HiddenMenuWrapper menuContent={<VibesPanel />}>
      <div className="container" style={{ padding: "24px" }}>
        ...
        <p style={{ marginBottom: "2rem", color: "#666", fontSize: "1.1rem" }}>
          The VibeControl component provides a floating action button that opens a full-screen overlay. It can be used both as a
          React component and mounted via JavaScript in non-React environments.
        </p>
      </div>
    </HiddenMenuWrapper>
  );
