  ...
  return (
    <div style={{ padding: "20px", maxWidth: "600px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "20px" }}>
        <p>
          Sync Status: <strong style={{ color: syncEnabled ? "green" : "red" }}>{syncEnabled ? "Enabled" : "Disabled"}</strong>
        </p>
        {!syncEnabled && (
          <button
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        {!syncEnabled && (
          <p style={{ color: "#dc3545", fontSize: "14px", marginBottom: "10px" }}>Please enable sync before sharing</p>
        )}
      ...
      <ul style={{ listStyle: "none", padding: 0 }}>
        {todos.map((todo) => (
          ...
          >
            <input type="checkbox" checked={todo.completed} onChange={() => toggleTodo(todo)} style={{ marginRight: "10px" }} />
            <span
              style={{
