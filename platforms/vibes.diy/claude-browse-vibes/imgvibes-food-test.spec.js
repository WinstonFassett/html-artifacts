...
test("ImgVibes food generation test - monitor console for 30s", async ({ page }) => {
  // Listen for console logs to capture ImgVibes debug output
  page.on("console", (msg) => {
  ...
  console.log("🚀 Starting ImgVibes food generation test...");
  ...
  console.log("📊 Watch for ImgVibes component activity, API calls, AI responses, and any errors...");
