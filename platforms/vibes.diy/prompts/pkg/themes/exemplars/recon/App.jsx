...
// Theme: Recon Grid — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.00 0.000 0), accent oklch(0.64 0.24 25).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Recon Grid theme — list, form, buttons rendered with the catalog tokens.
            </p>
