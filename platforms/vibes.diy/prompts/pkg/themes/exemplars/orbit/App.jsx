...
// Theme: Orbit Dashboard — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent oklch(0.79 0.21 152).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Orbit Dashboard theme — list, form, buttons rendered with the catalog tokens.
            </p>
