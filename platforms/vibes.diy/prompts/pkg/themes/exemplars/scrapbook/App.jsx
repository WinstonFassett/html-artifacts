...
// Theme: Scrapbook — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent oklch(0.93 0.03 130).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>An exemplar app on the Scrapbook theme — list, form, buttons rendered with the catalog tokens.</p>
