...
// Theme: Guild Ledger — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.10 0.03 260), accent oklch(0.60 0.13 80).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.90 0.03 260);
      --accent: oklch(0.40 0.13 80);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Guild Ledger theme — list, form, buttons rendered with the catalog tokens.
            </p>
