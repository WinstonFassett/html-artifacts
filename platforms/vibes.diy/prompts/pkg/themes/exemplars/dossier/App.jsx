...
// Theme: Dossier Card — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.16 0.000 0), accent #666.
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Dossier Card theme — list, form, buttons rendered with the catalog tokens.
            </p>
