...
// Theme: Hearth Sim — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent oklch(0.38 0.17 295).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Hearth Sim theme — list, form, buttons rendered with the catalog tokens.
            </p>
