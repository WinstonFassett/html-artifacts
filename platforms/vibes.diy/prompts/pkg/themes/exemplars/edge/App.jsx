...
// Theme: EDGE INTERFACE — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent #ff0077.
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the EDGE INTERFACE theme — list, form, buttons rendered with the catalog tokens.
            </p>
