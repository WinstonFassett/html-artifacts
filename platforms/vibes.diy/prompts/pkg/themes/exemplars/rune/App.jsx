...
// Theme: Rune Interface — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent #020406.
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Rune Interface theme — list, form, buttons rendered with the catalog tokens.
            </p>
