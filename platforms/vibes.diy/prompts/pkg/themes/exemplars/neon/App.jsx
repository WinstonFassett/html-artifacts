...
// Theme: Neon Arcade — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #fff, accent #f93c94.
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Neon Arcade theme — list, form, buttons rendered with the catalog tokens.
            </p>
