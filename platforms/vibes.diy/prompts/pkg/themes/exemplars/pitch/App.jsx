...
// Theme: Pitch — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.22 0.05 163), accent oklch(0.86 0.18 90).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.78 0.05 163);
      --accent: oklch(0.14 0.18 90);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>An exemplar app on the Pitch theme — list, form, buttons rendered with the catalog tokens.</p>
