...
// Theme: NeoMario — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.96 0.01 90), accent oklch(0.55 0.24 28).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>An exemplar app on the NeoMario theme — list, form, buttons rendered with the catalog tokens.</p>
