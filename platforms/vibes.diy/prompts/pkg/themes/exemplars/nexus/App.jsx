...
// Theme: Nexus Grid — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg #000000, accent #D4FF00.
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Nexus Grid theme — list, form, buttons rendered with the catalog tokens.
            </p>
