...
// Theme: Industrial — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.88 0.01 90), accent oklch(0.90 0.20 110).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Industrial theme — list, form, buttons rendered with the catalog tokens.
            </p>
