...
// Theme: Terminal CRT — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.16 0.000 0), accent oklch(0.00 0.000 0 / 0.85).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      ...
      --accent: oklch(0.97 0.000 0 / 0.85);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Terminal CRT theme — list, form, buttons rendered with the catalog tokens.
            </p>
