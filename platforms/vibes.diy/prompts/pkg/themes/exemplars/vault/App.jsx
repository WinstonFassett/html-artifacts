...
// Theme: Vault — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.08 0.03 280), accent oklch(0.72 0.15 75).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.92 0.03 280);
      --accent: oklch(0.28 0.15 75);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>An exemplar app on the Vault theme — list, form, buttons rendered with the catalog tokens.</p>
