...
// Theme: Palate Notes — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.17 0.000 0), accent oklch(0.93 0.006 265).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.83 0.000 0);
      --accent: oklch(0.07 0.006 265);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Palate Notes theme — list, form, buttons rendered with the catalog tokens.
            </p>
