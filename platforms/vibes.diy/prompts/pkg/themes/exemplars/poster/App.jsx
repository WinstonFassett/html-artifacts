...
// Theme: Poster — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.11 0.01 270), accent oklch(0.65 0.18 290).
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>An exemplar app on the Poster theme — list, form, buttons rendered with the catalog tokens.</p>
