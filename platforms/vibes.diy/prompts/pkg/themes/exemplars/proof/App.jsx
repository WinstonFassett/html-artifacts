...
// Theme: Proof Sheet — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.14 0.000 0), accent oklch(1.00 0.000 0 / 0.1).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.86 0.000 0);
      --accent: oklch(0.06 0.000 0 / 0.1);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Proof Sheet theme — list, form, buttons rendered with the catalog tokens.
            </p>
