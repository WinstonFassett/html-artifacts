...
// Theme: Rift Portal — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.07 0.02 280), accent oklch(0.88 0.27 128).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.93 0.02 280);
      --accent: oklch(0.12 0.27 128);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Rift Portal theme — list, form, buttons rendered with the catalog tokens.
            </p>
