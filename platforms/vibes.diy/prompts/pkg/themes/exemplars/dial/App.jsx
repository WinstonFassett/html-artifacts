...
// Theme: Dial Apparatus — auto-generated exemplar with prefers-color-scheme.
// Canonical palette: bg oklch(0.24 0.01 260), accent oklch(0.62 0.24 28).
...
const THEME_CSS = `
  ...
  @media (prefers-color-scheme: light) {
    :root {
      --bg: oklch(0.76 0.01 260);
      --accent: oklch(0.38 0.24 28);
      ...
      <main id="app" style={c.page}>
        <div style={c.container}>
          <header style={c.header}>
            ...
            <p style={c.subtitle}>
              An exemplar app on the Dial Apparatus theme — list, form, buttons rendered with the catalog tokens.
            </p>
