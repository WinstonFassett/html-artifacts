...
export interface VibesSwitchProps {
   ...
   *  same staggered durations the open/closed fill transition uses. */
  isTwinkling?: boolean;
}

export function VibesSwitch({ size = 24, className, isActive, onToggle, isTwinkling = false }: VibesSwitchProps) {
